        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              {/* Logo */}
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary-500 to-primary-600 shadow-lg flex items-center justify-center overflow-hidden">
                <img src="/icon.jpeg" alt="NE301 Logo" className="w-full h-full object-cover" />
              </div>
              <div>
            ...
            <section className="card p-5 border border-gray-100 dark:border-gray-800 flex flex-wrap items-end justify-between gap-4 hover:shadow-card-hover transition-shadow duration-300">
              <div className="flex gap-4 flex-wrap flex-1 items-end">
                ...
                <div className="min-w-[140px] flex-1 sm:flex-none">
                  ...
                  >
                    {PRESETS.map((p) => (
                      <option key={p.id} value={p.id}>{t(`preset${p.id}` as any)}</option>
                    ))}
                  </select>
                </div>
